...
/* Constants defined in PDF  */
#define MICROTCP_ACK_TIMEOUT_US 500000 // 500ms for safety
...
typedef struct
{
  ...
  size_t curr_win_size; // Peer's advertised window
  ...
  /* Sequence numbers */
  uint32_t seq_number; // My next sequence number to send
  uint32_t ack_number; // Next byte I expect to receive
